...
if __name__ == '__main__':
    ...
    doc_path_list = [
        ...
        # "tests/2.pdf",
        # "tests/3.pdf",
        r"E:\ah21PC\通用资料\排版\The Chicago Manual of Style, 18th Edition -- The University The University of Chicago Press Editorial -- 18, 2024 -- The University of Chicago Press.pdf",
    ]
